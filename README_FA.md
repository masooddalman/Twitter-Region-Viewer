...
این افزونه هیچ اطلاعات خصوصی را فاش نمی‌کند و هیچ داده‌ای فراتر از آنچه که به صورت عمومی در ایکس (توییتر) موجود است، ارائه نمی‌دهد. این افزونه صرفاً اطلاعات "Account based in" و "Connected via" را که خود توییتر در صفحه `/about` کاربر (مانند `x.com/username/about`) نمایش می‌دهد، دریافت و نشان می‌دهد.
